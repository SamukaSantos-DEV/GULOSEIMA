    ...
    if (texto !== "") {
      ...
      try {
        axios.post('http://192.168.1.104:3001/enviar-sugestao', {
          ...
          subject: 'Sugestão de ' + email.email, 
          html: texto,
        })
          .then(response => {
    ...
    <View style={{ flex: 1 }}>
      {!isTyping && (
        <View style={styles.mnsuperios}>
          ...
          <Image source={require('../assets/TituloSugestao.png')} style={styles.title} />
      ...
      <View style={styles.tela}>
        <View style={styles.cardPrincipal}>
          <Text style={styles.titleCP}>Dê-nos uma sugestão de produto para ser adicionado na cantina</Text>
          <TextInput
