...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        // Executar a lógica de excluir o produto
        ...
        <section
            ...
            <div class="modal" style="max-height: 97vh; overflow-y: auto; animation: pulse; animation-duration: 1.5s;">
                <form class="form" method="POST"
                        ...
                        <label for="file" class="labelFile" style="z-index: 1;">
                            <span>
                                <svg xml:space="preserve" viewBox="0 0 184.69 184.69"
                                    ...
                                    id="Capa_1" version="1.1" width="40px" height="40px">
                                    <g>
                                        <g>
                                            <g>
                                                <path
                    ...
                    <div id="fileNameDisplay"><?php echo htmlspecialchars($imagem); ?></div>
                    ...
                    <div class="credit-card-info--form">
                        <div class="input_container">
                            ...
                            <input id="nomeProd" class="input_field" type="text" name="nomeProd"
                                placeholder="Nome do Produto" value="<?php echo htmlspecialchars($nomeProd); ?>"
                                required>
                            <label class="input_label" style="padding-left: 5px; color: #ed862b;">* Campo
                                Obrigatório</label>
                        </div>

                        <div class="input_container">
                            <label for="quantidade" class="input_label">Quantidade:</label>
                            <input id="quantidade" class="input_field" type="text" name="quantidade"
                                placeholder="Quantidade" value="<?php echo htmlspecialchars($quantidade); ?>" required>
                            <label class="input_label" style="padding-left: 5px; color: #ed862b;">* Campo
                                Obrigatório</label>
                        </div>
                        ...
                        <div class="input_container">
                            ...
                            ?>
                            <label class="input_label" style="padding-left: 5px; color: #ed862b;">* Campos
                                Obrigatórios</label>
                        </div>

                        <div class="input_container">
                            <label for="valor" class="input_label">Valor:</label>
                            <input id="valor" class="input_field" type="number" name="valor" placeholder="Valor"
                                min="0.01" step="0.01" value="<?php echo htmlspecialchars($valor); ?>" required>
                            <label class="input_label" style="padding-left: 5px; color: #ed862b;">* Campo
                                Obrigatório</label>
                        </div>
                    </div>
